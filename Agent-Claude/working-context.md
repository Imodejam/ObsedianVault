...
DA FARE prima commit: (1) review bug+vuln (regola Stefano) sul flusso email/token; (2) decidere se tradurre i corpi notifica server (ora IT hardcoded, pattern esistente).
