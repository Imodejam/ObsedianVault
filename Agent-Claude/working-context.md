...
REVIEW pre-commit IN CORSO: 2 subagent bg — security/abuse (aa405455aa98836bf) + correttezza/bug (a607574d845dd9e6f). Poi sintetizzo findings a Stefano prima di committare.
