...
ANCORA APERTO: queue REVOKE+near consolidation+commit; Google auth prod grep; pagine per-job+SEO+sitemap dinamico (subagent a63fe2f43a47e8374 in corso); deploy pagina careers (dopo validazione); scelta SMS/Push per squillo bloccato.
