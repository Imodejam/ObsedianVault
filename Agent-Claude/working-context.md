...
TODO B.3: unificare ModeStep in UN solo "Prenota" che elenca tutti i servizi (ora lido mostra ancora split Appuntamento/Tavolo; le risorse stanno sotto "Appuntamento"). Poi: half_day/event raffinati, selezione addons (lettino/sdraio), risorse slot non-tavolo (campi) con orari, verifica browser. NON committato.
