...
- **Agenda L3/L4** (msg 3201): L1+L2 FATTI. L3 = vista planning griglia risorsa×giorni + overlap; L4 = azioni (segna incassato in loco, sposta risorsa, totali del giorno). IN CORSO ora.
