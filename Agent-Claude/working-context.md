...
VERIFICA adversariale IN CORSO: subagent a187dfa6dffbccb9e (prova a rompere i fix). Poi commit.
2 DECISIONI aperte a Stefano: (1) mail conferma app = email account da JWT, o permettere email digitata? (2) near: tenere boolean near_notified nuovo o consolidare su near_notified_at (timestamptz) esistente inutilizzato?
DEPLOY PROD (futuro): 2 migration in ordine — queue_remote_pending poi queue_remote_review_fixes.
