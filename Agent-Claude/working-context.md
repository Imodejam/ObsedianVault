...
NUOVA RICHIESTA B — pagina "Lavora con noi" stile Apple/Stripe su Vetrina, con annuncio BDR Italia (testo esatto di Stefano). DELEGATO subagent a0668732693ad6531 (bg, rilanciato dopo che a300c3a5 era andato a vuoto): route /lavora-con-noi + /{lang}/, lista posizioni (1 IT), CTA candidati→mailto info@, no deploy. Anteprima su collaudo prima di deploy.
