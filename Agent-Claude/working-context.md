...
- msg 3253 DATI NON PUBBLICI FINO A SALVA — DA FARE (refactor): oggi create/delete/rename di risorse+decorazioni salvano SUBITO; solo lo spostamento è bufferizzato. Serve bufferizzare TUTTO (set _newTableIds/_deletedTableIds + analoghi deco) e flush solo in Save(); Abbandona/Reload scarta. RISCHIO: persistenza editor complessa, attenzione a id/diff.
- msg 3254 COMANDI DECORAZIONI = COMANDI RISORSE — DA FARE: allineare action pill decorazioni (oggi Rinomina/Elimina) a quelle risorse (ruota/duplica/modifica/elimina).
