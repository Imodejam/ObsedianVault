...
- [2026-05-05] **Cost reduction modelli counselor**: Stefano via Telegram (msg 1145, "consuma troppo") → tutti i counselor passano a `claude-haiku-4-5-20251001` tranne `critic` che resta `claude-sonnet-4-6` (stress-test cross-quality). Cambi: architect/security/product/praeses (sonnet→haiku), synthesizer/Princeps (opus-4-7→haiku). Invariati: ux/cost (già haiku), critic-openai (gpt-4o, indipendenza cross-family). Servizio `concilium.service` fermato durante l'edit, da riavviare.
