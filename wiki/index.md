...
- [[wiki/projects/puntify|Puntify]] — Fidelity card digitale per esercenti (primo target Roma). Ambiente CAT live 2026-05-16.
  ...
  - [[wiki/projects/puntify-play-store-listing|Puntify · Scheda Google Play (it.puntify.app)]] — scheda ASO in 12 lingue caricata via API v3 e tenuta in BOZZA; linea "trasversale" (studi/professionisti + negozi/ristorazione); gotcha locale `ro`/`uk` e path immagini `/listings/`
...
- [[projects/puntify-social-studio]] — Social Studio: stato + 4 interventi 19/07 (modifica post, sentiment su import, cadenza+profondita 1anno configurabili, immagini via link)
- [[projects/kirweb-visual-playbook]] — analisi profonda 23 creativita' KiRweb (Foxy+Roadhouse): schedatura immagine-per-immagine + 10 pattern da replicare nella Social Skin Puntify
- [[projects/puntify-ordini-menu-flusso]] — Flusso ordini menu dine-in: analisi casi/coperto/gap + nodo conto-tavolo (A/B in attesa Stefano)
